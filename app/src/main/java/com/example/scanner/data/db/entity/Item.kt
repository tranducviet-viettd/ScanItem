...
data class Item(
    ...
    @get:PropertyName("price")@set:PropertyName("price") var price: Price = Price(),
...
data class Price(
    @get:PropertyName("piece")@set:PropertyName("piece") var piece : String = "",
    @get:PropertyName("pack")@set:PropertyName("pack") var pack : String = "",
    @get:PropertyName("box")@set:PropertyName("box") var box : String = "",
)